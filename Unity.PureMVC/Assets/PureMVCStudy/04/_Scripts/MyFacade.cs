...
/// 
/// </summary>
public class MyFacade04 : PureMVC.Patterns.Facade {
    ...
    /// </summary>
    /// <returns></returns>
    public static MyFacade04 GetInstance()
    {
        return m_instance as MyFacade04;
    }
    ...
    protected override void InitializeController () {
        ...
        //注册Command
        RegisterCommand (START_UP, typeof (LaunchCommand));
    ...
    {
        //通过command命令启动游戏
        SendNotification(MyFacade04.START_UP);
    }
