...
public class MainPanelMediator : PureMVC.Patterns.Mediator {
    ...
    public void OnClickPlay () {
        ...
        SendNotification (MyFacade04.PLAY);
    }
    ...
    public override void HandleNotification (INotification notification) {
        switch (notification.Name) {
            case MyFacade04.REFRESH_BONUS_UI:
                ...
                break;
            case MyFacade04.UPDATE_PLAYER_DATA:
                {
                    //更新UI
                    if (playerData != null) {
                        ...
                        SendNotification (MyFacade04.REWARD_TIP_VIEW, notification.Body);
    ...
    public override IList<string> ListNotificationInterests () {
        IList<string> list = new List<string> () { MyFacade04.REFRESH_BONUS_UI, MyFacade04.UPDATE_PLAYER_DATA };
